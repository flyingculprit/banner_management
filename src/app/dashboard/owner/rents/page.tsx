                ...
                rentals.map((rental) => {
                  ...
                  return (
                    <tr key={rental.id} className="hover:bg-slate-800/40 transition">
                      <td className="p-4">
                        <div className="font-semibold text-white">{rental.spaces?.area}, {rental.spaces?.city}</div>
                        <div className="text-[11px] text-slate-400">{rental.spaces?.width} × {rental.spaces?.height} ft</div>
                      </td>
                      <td className="p-4">
                        <div className="text-slate-200 font-medium">{rental.profiles?.full_name}</div>
                      ...
                      <td className="p-4 font-bold text-emerald-400">₹{Number(rental.owner_amount).toLocaleString()}</td>
                      <td className="p-4">
